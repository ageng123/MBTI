                ...
                <tr>
                    ...
                    <td>
                        <div class="text-center">
                            ...
                            <div class="btn-group">
                                <a href="<?= base_url('Dashboard/Pelanggaran/Usulan/' . $url . ''); ?>" class="btn waves-effect waves-light btn-primary btn-xs" title="Edit data pelanggaran"><i class="fas fa-check-circle"></i></a>
